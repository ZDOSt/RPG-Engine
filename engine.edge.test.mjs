...

{
    ...
    assert.match(payload, /NAME_STYLE_PRESET: Custom/);
    assert.match(payload, /CUSTOM_NAME_STYLE: elegant desert empire names/);
    assert.match(payload, /MALE_NAME_CANDIDATES: Maelor/);
    assert.match(payload, /FEMALE_NAME_CANDIDATES: Aelith/);
    assert.match(payload, /NEUTRAL_NAME_CANDIDATES: Caelis/);
    assert.match(payload, /NEXT_MALE_NAME: Maelor/);
